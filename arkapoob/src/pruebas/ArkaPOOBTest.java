...
public class ArkaPOOBTest {
	...
	Recursos.init();
        ArkaPOOB juego = new ArkaPOOB(800,800);
        juego.nextLvl();        
	...
	Recursos.init();
        Player jugador = new Player(3,1,new Vector2D(0,0), new ArkaPOOB(800,800));       
	...
	Recursos.init();
        BloqueIndestructible bloque = new BloqueIndestructible(new Vector2D(205,220),Recursos.bloqueIndestructible,new ArkaPOOB(800,800)); 
	...
	Recursos.init();
        BloqueDuro bloque = new BloqueDuro(new Vector2D(205,220),Recursos.bloqueIndestructible,new ArkaPOOB(800,800)); 
        int puntosGanados = bloque.disminuirRes(1000);
